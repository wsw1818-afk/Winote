...
/// 문서 영역 조정 페이지
/// 자동 감지된 4꼭짓점을 수동으로 조정할 수 있음
class CropPage extends StatefulWidget {
  final String imagePath;
  final List<String>? batchImages; // 배치 모드 시 전체 이미지 목록
